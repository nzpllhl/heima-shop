...
const mode = ref< SkuMode>(SkuMode.Both) // 默认是1
// 点击购物车打开SKU弹窗改变两个数据
...
<template>
  <!-- SKU弹窗组件
  add-cart-background-color="#FFA868" 修改加入购物车按钮
  buy-now-background-color="#27BA9B" 修改立即购买按钮
   :actived-style="{
      color: '#27BA9B',
      borderColor: '27BA9B',
  ...
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      ...
      <!-- 操作面板 -->
      <view class="action">
        <view class="item arrow" @tap="$event =>openSkuPopup(SkuMode.Both)">
